...
const DATE_RANGES = {
  ...
  "1M": { label: "Последний месяц", days: 30 },
  "3M": { label: "Последние 3 месяца", days: 90 },
  "6M": { label: "Последние 6 месяцев", days: 180 },
    ...
    <Card>
      ...
      <CardContent>
        <div className="flex justify-around mb-6 text-sm">
          ...
          <div className="text-center">
            <p className="text-muted-foreground">Общие расходы</p>
            <p className="text-lg font-bold text-red-500">
              {totals.expense.toFixed(2)}₽
            </p>
          </div>
          <div className="text-center">
            <p className="text-muted-foreground">Чистый итог</p>
            <p
